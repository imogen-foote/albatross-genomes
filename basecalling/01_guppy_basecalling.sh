...
## Script for basecalling of raw ONT data from Kit 12 (SQK-LSK112) library prep/R10.4 MinION sequencing runs (.fast5)
...
read_dir=/path/to/raw_data/ont/$LIB
...
# Remove individual fastq files and tmp directory
